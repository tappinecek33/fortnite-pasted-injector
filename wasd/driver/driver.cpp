#include "driver.h"
#include "../api/xor.h" /// change this driver, this is from original source and its detected /// use own driver or some from github ez as that

#define DVR_DEVICE_FILE xor_w(L"\\\\.\\EIQDV") /// get driver name from hxd, download hxd and get driver name (mamkadrv, loldrive, fortdrve) /// just scroll down to find this: //driver//"d.r.i.v.e.r.n.a.m.e"
